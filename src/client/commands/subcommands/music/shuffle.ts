...
export const shuffle = {
    data: new SlashCommandSubcommandBuilder()
        ...
        .setNameLocalizations({
            "en-US": t("commands.music.subcommands.shuffle.name", "en-US"),
            "pt-BR": t("commands.music.subcommands.shuffle.name", "pt-BR"),
        })
        .setDescription(t("commands.music.subcommands.shuffle.description", "en-US"))
        .setDescriptionLocalizations({
            "en-US": t("commands.music.subcommands.shuffle.description", "en-US"),
            "pt-BR": t("commands.music.subcommands.shuffle.description", "pt-BR"),
        }),
    usage: "/music shuffle",
        ...
        try {
            ...
            if (response.event === "shuffle_error") {
                ...
                if (response.error === "NO_QUEUE") {
                    ...
                    embed.setDescription(t("commands.music.subcommands.shuffle.response.empty", locale));
                } else {
                    embed.setDescription(t("misc.error_ocurred", locale));
                }
            } else {
                embed.setColor(`#${colors.default_color}`);
                embed.setDescription(t("commands.music.subcommands.shuffle.response.shuffled", locale));
            }
