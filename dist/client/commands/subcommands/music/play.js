    ...
    execute: (interaction, socket) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            if (responseData.event == 'song_added') {
                ...
                const errName = typeof responseData.e === 'object' ? (_a = responseData.e) === null || _a === void 0 ? void 0 : _a.name : '';
                const errorMsg = errName === 'NoResultError'
                    ? (0, localization_1.t)('player.errors.no_results', locale)
                    : (0, localization_1.t)('misc.error_ocurred', locale);
