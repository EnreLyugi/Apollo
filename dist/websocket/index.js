 ...
 */
exports.ready = (() => __awaiter(void 0, void 0, void 0, function* () {
    yield Promise.resolve().then(() => __importStar(require('./client/')));
    yield (0, player_1.initializePlayer)();
    yield Promise.resolve().then(() => __importStar(require('./socket/')));
}))();
process.on('SIGINT', () => {
