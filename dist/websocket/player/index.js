...
exports.getPlayer = exports.initializePlayer = void 0;
const discord_player_1 = require("discord-player");
const extractor_1 = require("@discord-player/extractor");
const client_1 = __importDefault(require("../client/"));
const playerEvents = __importStar(require("./events"));
let playerInstance = null;
const initializePlayer = () => __awaiter(void 0, void 0, void 0, function* () {
    if (playerInstance) {
        return playerInstance;
    }
    const player = new discord_player_1.Player(client_1.default, {
